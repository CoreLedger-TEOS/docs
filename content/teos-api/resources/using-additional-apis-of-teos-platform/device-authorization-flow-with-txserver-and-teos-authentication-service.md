...
<figure><img src="../../assets/gitbook/Ext Mobile App Auth Flow (6).png" alt=""><figcaption><p>Diagram 1. Mobile Application Authorization Flow</p></figcaption></figure>
...
**Step 1.3.** The user authentication process should be started from the call to [Authorize ](./using-teos-authentication-service/README.md#authorize-endpoint)endpoint of the Auth server.
...
**Step 1.4.** The application calls [Token ](./using-teos-authentication-service/README.md#token-endpoint)endpoint of Auth server with the 'authorization\_code' grant type and the code, acquired in Step 1.3.R.
