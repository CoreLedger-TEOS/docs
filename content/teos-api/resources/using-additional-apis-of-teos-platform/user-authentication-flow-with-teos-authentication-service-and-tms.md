...
<figure><img src="../../assets/gitbook/TMS Auth Flow (2).png" alt=""><figcaption><p>User authentication flow</p></figcaption></figure>
...
Please refer to [authentication-types.md](../../get-started/authentication-types.md "mention")the for more details about the authentication types.
