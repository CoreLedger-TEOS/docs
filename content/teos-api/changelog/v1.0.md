...
| ------ | -------- | ------- |
| `POST` | `/odata/v1.1/Assets({key})/Amendment` | Create an amendment for the specified asset |
| `GET` | `/odata/v1.1/Assets({key})/ChangeLog` | Retrieve the original asset and its amendments |
