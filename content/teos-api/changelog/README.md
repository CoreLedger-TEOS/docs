...
!!! note "Note"
    Check [versioning.md](versioning.md "mention") concept to make sure you organize your work in sync with TEOS API updates and you understand which influence different types of changes can have on your solution
...
| ----------------------------------------------------------------------------- | ------------- |
| [TMS API](../resources/using-additional-apis-of-teos-platform/using-tms-api/) | v1            |
