...
<figure><img src="../assets/image (39).png" alt=""><figcaption><p>KYC cases status settings: when WLP must close cases automatically based on verification results received from the KYC provider</p></figcaption></figure>
...
![All cases are filtered by status = "Open" by default, remove filter to check all cases](<../assets/image (11).png>)

![Example of positive verification results (KYC request status is Accepted), admin can either Approve or Decline KYC case](<../assets/image (4).png>)
