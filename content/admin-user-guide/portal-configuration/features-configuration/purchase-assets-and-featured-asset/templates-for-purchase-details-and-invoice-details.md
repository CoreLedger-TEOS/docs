...
*   You can use the table for listing the purchased items. The template document may have multiple tables. To find the appropriate one to list the purchased items, please set the description of the table to “Purchased Items”:\
    ...
    <figure><img src="../../../../assets/image (7).png" alt=""><figcaption><p>How to create the table for listing the purchased items</p></figcaption></figure>
...
<figure><img src="../../../../assets/image (2) (1) (1).png" alt=""><figcaption><p>Example of the table</p></figcaption></figure>
