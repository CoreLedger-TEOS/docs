...
*   Description of the method in all available languages for the portal which will be shown to user in the checkout flow under "More details" button of the collection method\
    ...
    <div><figure><img src="../../../../assets/image (24).png" alt=""><figcaption><p>Description definition in the Configuration management</p></figcaption></figure> <figure><img src="../../../../assets/image (30).png" alt=""><figcaption><p>Description is shown under "More details" in user checkout flow</p></figcaption></figure></div>
