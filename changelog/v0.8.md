...
**Released** internally| **Supported until** internally
...
* In order to introduce the support of api key for [creating and signing transactions](../overview/transaction-creation-and-submission.md) following changes were done:
...
* :point\_right:Signing  flow with user token is changed according to the description in [#flow-with-user-token](../overview/transaction-creation-and-submission.md#flow-with-user-token "mention")
...
* Signing  flow with user token is changed according to the description in [#flow-with-user-token](../overview/transaction-creation-and-submission.md#flow-with-user-token "mention")
