...
2.  Subscription to search results.
    ...
    Search results are returned as RabbitMQ events (Please refer to [this section](/overview/teos-events/) for details about connection to RabbitMQ of TEOS Api).
