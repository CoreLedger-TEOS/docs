---
slug: /using-additional-apis-of-teos-platform/using-discovery-service
---
...
| ------------------------------------ | ------ | ------------------------------------------------------------------- |
| id\* | String | Bundle ID or Front-End FQDN, e.g. "com.coreledger.txmobile.android" |
...
#### 200: OK App configuration and endpoints
