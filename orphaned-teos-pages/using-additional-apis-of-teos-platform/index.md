...
slug: /using-additional-apis-of-teos-platform
---
...
[**Tenant Management Service /TMS/**](./using-tms-api/index.md) is used to get user data and sign up new user in TEOS Platform.
