---
slug: /using-additional-apis-of-teos-platform/using-tms-api/handling-errors
---

# Handling errors

Errors structure and errors handling approach is the same for all TEOS Platform APIs. Please, refer to [handling-errors](/overview/handling-errors/) for the info about handling errors received from TMS API.
