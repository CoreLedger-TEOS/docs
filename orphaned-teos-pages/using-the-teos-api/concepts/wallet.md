---
slug: /using-the-teos-api/concepts/wallet
---
...
Public address is used to identify wallet in all [spark operations](./spark.md#spark-operation) as a spark sender and spark receiver. Public address is publicly available. Public addresses are created from the private key through a complicated mathematical algorithm.
