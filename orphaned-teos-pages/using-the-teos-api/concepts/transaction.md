---
slug: /using-the-teos-api/concepts/transaction
---
...
![](/img/gitbook-assets/untitled.drawio.svg)
...
:::info
Check the detailed flow of creating and submitting transactions with TEOS API in [transaction-creation-and-submission](../../overview/dealing-with-blockchain-transactions/transaction-creation-and-submission/index.md)
:::
