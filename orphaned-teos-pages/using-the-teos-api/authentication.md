...
slug: /using-the-teos-api/authentication
---
...
Check [tenant-setup-options.md](./architecture-note/tenant-setup-options.md) for more info about why you may need specific authentication type.
...
_Example of the functionality not supported with api key_
