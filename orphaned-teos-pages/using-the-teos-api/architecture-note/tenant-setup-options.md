...
slug: /using-the-teos-api/architecture-note/tenant-setup-options
---
...
The authentication process for TEOS API consumers is described in [authentication.md](../authentication.md). The description below can help you decide on which option to go.
...
![](/img/gitbook-assets/data-layers-copy-of-page-2.drawio.svg)
