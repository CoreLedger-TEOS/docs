---
slug: /using-the-teos-api/architecture-note/blockchain-networks
---
...
| --------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------ |
| Transaction processing time | Extremely fast, typically 1–2 seconds. [Check current statistics](https://dashboard.internetcomputer.org/transactions)                                                                                           | Typically low, usually 2–5 seconds due to high throughput and low block times.<br />[Check current statistics](https://polygonscan.com/)<br /> | Typically slower, often estimated in minutes, depending on transaction volume and node availability. [Check current statistics](https://etherscan.io/) | Typically low, 10-15 seconds. <br />[Check current statistics](https://netstats-sparknet.coreledger.net/) | Typically low, 14-21 seconds.                                                                                      |
