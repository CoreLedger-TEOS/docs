...
slug: /using-the-teos-api/architecture-note
---
...
* throttling of requests, when the quota is reached (see [Rate Limits](/overview/rate-limits/))
...
RabbitMQ is the widely deployed open-source message broker. It is used to deliver TEOS events. More details about its usage with the TEOS can be found [here](/overview/teos-events/#subscribing-to-events).
