...
2.  Subscription to search results.
    ...
    Search results are returned as RabbitMQ events (Please refer to [teos-events.md](../../../../overview/teos-events.md "mention")for details about connection to RabbitMQ of TEOS Api).
