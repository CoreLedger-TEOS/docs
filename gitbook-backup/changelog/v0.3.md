...
* In order to introduce the support of api key for [creating and signing transactions](../resources/dealing-with-blockchain-transactions/transaction-creation-and-submission/) following changes were done:
...
* :point\_right:Signing flow with user token is changed according to the description in [#flow-with-user-token](../resources/dealing-with-blockchain-transactions/transaction-creation-and-submission/#flow-with-user-token "mention")
...
* Signing flow with user token is changed according to the description in [#flow-with-user-token](../resources/dealing-with-blockchain-transactions/transaction-creation-and-submission/#flow-with-user-token "mention")
