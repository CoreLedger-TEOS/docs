...
The TEOS API has multiple versions. You can read more about versioning in [versioning.md](../changelog/versioning.md "mention"), but here we'll explain how you make a call to a specific version.
...
{% hint style="info" %}
Please, note that additional APIs used together with the TEOS API may have their own versions or may have no versioning at all. Please, check the [documentation of the specific API](../resources/using-additional-apis-of-teos-platform/) to find out its versioning concept
{% endhint %}
