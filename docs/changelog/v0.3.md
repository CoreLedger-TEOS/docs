...
* :point\_right:Signing flow with user token is changed according to the description in [Flow with a user token](../resources/dealing-with-blockchain-transactions/transaction-creation-and-submission/index.md#flow-with-a-user-token)
...
* Signing flow with user token is changed according to the description in [Flow with a user token](../resources/dealing-with-blockchain-transactions/transaction-creation-and-submission/index.md#flow-with-a-user-token)
