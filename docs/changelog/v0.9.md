...
<p className="doc-description">TEOS API Version 0.9 release notes</p>
...
Transaction parameters for further signing and submitting are returned as a response according to [Transaction creation and submission](../resources/dealing-with-blockchain-transactions/transaction-creation-and-submission/index.md).
...
* We've improved our system of error handling. You can always check the error codes in [Handling errors](../overview/handling-errors/index.md) section
