...
- **[Authentication](./authentication-types.md)** - Learn how different types of access tokens work
- **[Guides](../guides/index.md)** - Learn which main concepts TEOS platform operates
- **[API reference](../reference/index.md)** - Check API description and common rules how to use it
- **[TEOS API overview](../resources/using-the-teos-api/index.md)** - Check how TEOS API overview as part of TEOS platform to make sure you're fully prepared to get maximum of it
