...
You can send tokens from WLM to external wallets via “WLM - Transfer token”. Below is a short instruction how to do it and how to import token data to such popular wallets as Trust Walle and MetaMask.
