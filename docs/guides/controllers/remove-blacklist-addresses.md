...
`application/json`  — Object containing the addresses to remove from the blacklist.

| **Parameter** | **Type**         | **Description**                                                         | **Mandatory** |
| ------------- | ---------------- | ----------------------------------------------------------------------- | ------------- |
| addresses     | array of strings | List of blockchain addresses to remove from the controller’s blacklist. | ✅             |
...
`application/json`  — Returns the created transaction object for removing blacklist addresses.
...
| Type                    | string        | Transaction type (e.g., RemoveBlacklistAddresses).                     |
