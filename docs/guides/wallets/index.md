...
Public address is used to identify wallet in all [spark operations](../../resources/using-the-teos-api/concepts/spark.md#spark-operation) as a spark sender and spark receiver. Public address is publicly available. Public addresses are created from the private key through a complicated mathematical algorithm.
