...
<p className="doc-description">How to create TEOS account, profile in WLM and to setup TX.Mobile and new wallet</p>
...
After that you are welcome to check [admin functionality](../admin-user-guide/index.md) or [end user's functionality](../user-guide/index.md) overview.
