...
2.  Subscription to search results.
    ...
    Search results are returned as RabbitMQ events (Please refer to [TEOS events](../../../../overview/teos-events.md) for details about connection to RabbitMQ of TEOS Api).
