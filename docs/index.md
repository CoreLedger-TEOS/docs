...
Interested in TEOS API capabilities?[ Book a free discovery call](https://coreledger.net/book-a-call/) with our Customer Relations Manager.



- **[Overview](./resources/using-the-teos-api/index.md)** - Learn how the TEOS API fits into the TEOS platform, how versions work, and how authentication works.
- **[Get started](./get-started/index.md)** - Learn how to use the TEOS API with detailed guides and practical examples.
- **[Using TEOS API](./overview/index.md)** - Learn which common rules are important for users.
- **[API Reference](./reference/index.md)** - Learn how to read our reference documents so you can easily find what you are looking for.
