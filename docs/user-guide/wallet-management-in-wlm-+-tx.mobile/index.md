...
After you add the wallet to Other wallets list you can add it to controllers [controller-management.md](../controller-management.md) or as a target address for units transfer in WLM or even as a collection method in WLP [White Label Portal](https://app.gitbook.com/o/ZaeNizhnU47lCcTSk7wB/s/iTYqY7GQFlQO0s8Vbk2r/ "mention")
