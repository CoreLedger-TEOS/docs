...
Check the flow of creating transactions with TEOS API in [transaction-creation-and-submission.md](../using-the-teos-api/transaction-creation-and-submission.md "mention")
